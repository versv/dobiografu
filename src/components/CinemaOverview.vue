      ...
      cinemaList: [
        {
          ...
          specialProgrammeTypes: [
            "✓ Divadlo v kině - NT Live, The Royal Shakespeare Company",
          ...
          bar: " ✓",
          transport: [
            "metro: Můstek - linka A/B",
            "tramvaj: Vodičkova - linka: 3, 5, 6, 9, 14, 24"
            ],
...

        {
          ...
          barrierFree: " ✓",
          bar: " ✓",
          transport: ["tramvaj: Kamenická - linka: 1, 8, 12, 25, 26"],
...

        {
          ...
          bar: " ✓",
          transport: [
            "tramvaj: Biskupcova - linka: 9, 10, 11, 16; Ohrada - linka: 1, 9, 11", 
            "autobus č. 133, 136 207"
            ],
...

        {
          ...
          bar: " ✗",
          transport: [
            "tramvaj: Krymská - linka: 4, 22",
            "autobus: Krymská - linka: 135"],
          link: "http://www.kinopilotu.cz/",
          image: "Kino_pilotu.jpg",
          alt: "Kino Pilotů",
        ...
        },
        {
          ...
          bar: " ✓",
          transport: [
            "metro: Karlovo náměstí, linka B", 
            "tramvaj: Karlovo náměstí - linka: 2, 3, 6, 14, 18, 22"
            ],
...

        {
          ...
          bar: " ✓",
          transport: [
            "metro: Florenc, linka B/C", 
            "tramvaj: Florenc - linka: 3, 8, 24, Těšnov - linka: 14"
            ],
...

        {
          ...
          bar: " ✓",
          transport: [
            "metro: Národní - linka B, Můstek - linka: A/B", 
            "tramvaj: Národní třída - linka: 1, 2, 9, 18, 22"
            ],
...

        {
          ...
          bar: " ✓",
          transport: [
            "tramvaj. zastávka: Malovanka - linka: 22, 23, 35", 
            "autobus: Malovanka - linka: 143, 149"
            ],
