...
const cinemaList = [

  {
    ...
    tagline: "Domov slavného Kinoautomatu a bývalý kabaret. Kankán se tu už netancuje, ale atmosféra je pořád špičková.",
    specialProgramme: true,
    specialProgrammeTypes: [
      "Divadlo v kině - NT Live, The Royal Shakespeare Company", "Opera v kině - The Met: Live in HD", "Bio Senior", "Umění v kině", "Catch-up - English friendly", "Řada různých festivalů"
    ],
    barrierFree: false,
    bar: true,
...

  {
    ...
    tagline: "Elegance sama. V secesním kinosále si připadáte jako v divadle. V malém sále vám zase bude dělat společnost James Dean.",
    specialProgramme: true,
    specialProgrammeTypes: [
      "Výstavy na plátnech kin", "Pro seniory", "Cestovatelské kino", "Balet v kině - Bolšoj balet", "Ladies Movie Night", "English friendly", "Řada různých festivalů"
    ],
    barrierFree: false,
    bar: true,
    transport: "metro: Můstek - linka A/B, tramvaj.zastávka: Vodičkova - linka: 3, 5, 6, 9, 14, 24",
...

  {
    ...
    tagline: "Oblíbené nejen letenskými hipstery. Je libo shlédnout film z pohodlí staré karosérie nebo plážového lehátka?",
    specialProgramme: true,
    specialProgrammeTypes: [
      "Divadlo v kině - NT Live", "Opera v kině - The Met: Live in HD", "Bio Senior", "Malé oči", "Baby bio", "Filmový klub", "Naslepo", "English friendly", "Řada různých festivalů"
    ],
    barrierFree: true,
    bar: true,
...

  {
    ...
    tagline: "Nenápadný žižkovský klenot s dvorem ve vnitrobloku, ideálním na pofilmové diskuze nad sklenkou vína.",
    specialProgramme: true,
    specialProgrammeTypes: [
      "Divadlo v kině - NT Live", "Opera v kině - The Met: Live in HD", "Bio Senior", "Malé oči", "Baby bio", "Filmový klub", "Naslepo", "Legendy v Aeru", "English friendly", "Řada různých festivalů"
    ],
    barrierFree: true,
    bar: true,
...

  {
    ...
    tagline: "Funkcionalistický poklad v Domě Radosti s barem přímo v sále. Cashless.",
    specialProgramme: true,
    specialProgrammeTypes: ["Divadlo v kině - NT Live", "English friendly", "Půlnoční projekce", "Film & Breakfast"],
    barrierFree: false,
    bar: true,
...

  {
    ...
    specialProgramme: true,
    specialProgrammeTypes: [
      "Bio Senior", "Bio Junior", "Severský filmový čtvrtek"
    ],
    barrierFree: false,
    bar: true,
...

  {
    ...
    tagline: "Kino Národního filmového archivu, které promítá spoustu nejen českých pokladů.",
    specialProgramme: true,
    specialProgrammeTypes: [
      "Činohrení klub 55", "Film před sto lety", "Midnight movies", "Filmy a klima", "Ponrepo dětem", "Paralelní kino"
    ],
...

  {
    ...
    tagline: "Pokud milujete tvorbu jednoho režiséra, bude se vám líbit cyklus Retrospektivy - nedávno promítali třeba všechny filmy Bratří Coenů.",
    specialProgramme: true,
    specialProgrammeTypes: [
